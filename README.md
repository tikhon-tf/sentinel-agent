...
+------------------------+
    ...
    |    +-------------------+
    |         |
    |         +---> retrieve_regulation_rag (Pinecone semantic search, default)
    |         | AND/OR retrieve_regulation_nexus (Nexus KnowQL, via AGENT2_RETRIEVAL)
